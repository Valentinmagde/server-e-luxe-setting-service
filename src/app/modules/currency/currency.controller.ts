...
class CurrencyController {
  ...
  public async show(req: Request, res: Response): Promise<void> {
    ...
    if (checkObjectId(currencyId)) {
        ...
        .then((result) => {
          if (result === null || result === undefined) {
            const response = {
              ...
              errMsg: i18n.__("currency.currencyNotFound"),
            };
      ...
      const response = {
        ...
        errMsg: i18n.__("currency.invalidCurrencyId"),
      };
  ...
  /**
   * Get all showing currencies details handler
   *
   * @author Valentin Magde <valentinmagde@gmail.com>
   * @since 2024-08-15
   *
   ...
   */
  public async getShowingCurrency(req: Request, res: Response): Promise<void> {
    currencyService
      .getShowingCurrency()
      .then((result) => {
        const response = {
  ...
  /**
   * Get all currency details handler
   *
   * @author Valentin Magde <valentinmagde@gmail.com>
   * @since 2024-08-15
   *
  ...
  /**
   * Add many currencies route handler
   *
   * @author Valentin Magde <valentinmagde@gmail.com>
   * @since 2024-08-15
   *
      ...
      .validator(
        ...
        (err: Errors, status: boolean) => {
          if (!status) {
            ...
            const currencyId = req.params.currencyId;
            // check if currency id is valid
            if (checkObjectId(currencyId)) {
              currencyService
                .update(currencyId, req.body)
                .then((result) => {
                  if (result === null || result === undefined) {
                    const response = {
                      status: statusCode.httpNotFound,
      ...
      .validator(
        ...
        (err: Errors, status: boolean) => {
          if (!status) {
            ...
            if (checkObjectId(currencyId)) {
              currencyService
                .updateStatus(currencyId, req.body)
                .then((result) => {
                  if (result === null || result === undefined) {
                    const response = {
                      status: statusCode.httpNotFound,
   ...
   * @return {Promise<void>} the eventual completion or failure
   */
  public async updateLiveExchangeRateStatus(req: Request, res: Response): Promise<void> {
    const validationRule = {
      live_exchange_rates: "required|string",
    };
      ...
      .validator(
        ...
        (err: Errors, status: boolean) => {
          if (!status) {
            ...
            if (checkObjectId(currencyId)) {
              currencyService
                .updateLiveExchangeRateStatus(currencyId, req.body)
                .then((result) => {
                  if (result === null || result === undefined) {
                    const response = {
                      status: statusCode.httpNotFound,
  ...
  public async deleteMany(req: Request, res: Response): Promise<void> {
    const currencyIds = req.params.currencyIds.split(",");

    currencyService
      .deleteMany(currencyIds)
      .then((result) => {
        if (result === null || result === undefined) {
          const response = {
            status: statusCode.httpNotFound,
